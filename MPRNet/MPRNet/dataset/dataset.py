...
class DAVIS_MO_Test(data.Dataset):
    ...
    def __init__(self, root, imset='2017/train.txt', resolution='480p', single_object=False):
        ...
        # self.mask_dir = "/data/jialewang/SSM-VOS1/models/pretrained/results/SSM-davis17_Val-merged"
        # self.mask480_dir = "/data/jialewang/SSM-VOS1/models/pretrained/results/SSM-davis17_Val-merged"
